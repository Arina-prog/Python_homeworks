...
#petq e sarqel 3 Python module, 1-um input anel tiv ev astichan ev hashvel, 2-um hashvel mnacord bajaneluc
# inch vor tiv inch vor myus tvin, 3-um katarel gortsoxutunner nman 1 ev 2 modulneri

import degree_counter
import quotient

print(degree_counter.count / quotient.quotient)
